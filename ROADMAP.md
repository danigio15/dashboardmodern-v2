...
See CHANGELOG.md. Phase-by-phase implementation notes for phases 7 and 8 are
recorded in the repository history; docs/SECTION_ROADMAP.md carries the
current per-section state.
