...
const CD_SYNC_KEYS = ['dm_dashboard_state','cd_connection','cd_branding','cd_sections','cd_section_names','cd_luci','cd_luci_rooms','cd_stanze','cd_cameras','cd_appliances','cd_loads','cd_energy_model','cd_clima_units','cd_quick_actions','cd_termico_caldo','cd_lavatrice_programmi','cd_devices','cd_ev_image','cd_entity_overrides','cd_tapparelle','cd_irrigazione','cd_piscina','cd_ev_cars','cd_energy_views','cd_navbar_order','cd_floors','cd_slot_labels','cd_flow_nodes','cd_avvisi_custom','cd_text_overrides','cd_hidden_elements'];
