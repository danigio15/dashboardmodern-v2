...
const RELEASE_VERSION = "1.0.0-beta.12";
...
test("the 1.0 beta release metadata is consistently versioned", async () => {
  ...
  assert.match(buildInfo, /["']?integrationVersion["']?\s*:\s*["']1\.0\.0-beta\.12["']/);
  assert.match(buildInfo, /["']?dashboardVersion["']?\s*:\s*["']1\.0\.0-beta\.12["']/);
