...
test("built-in registries are deterministic and compatibility renderer APIs report real types", () => {
  ...
  assert.deepEqual(first.types(), ["battery-status", "camera-status", "climate-control", "cover-control", "energy-flows", "energy-overview", "fan-control", "grid-status", "home-summary", "legacy-panel", "light-control", "media-player-control", "sensor-status", "solar-production", "switch-control", "vacuum-control", "weather-current", "weather-forecast"]);
  assert.deepEqual(second.types(), ["battery-status", "camera-status", "climate-control", "cover-control", "energy-flows", "energy-overview", "fan-control", "grid-status", "home-summary", "legacy-panel", "light-control", "media-player-control", "sensor-status", "solar-production", "switch-control", "vacuum-control", "weather-current", "weather-forecast"]);
  ...
  assert.deepEqual(cardRendererTypes(second), ["battery-status", "camera-status", "climate-control", "compat-card", "cover-control", "energy-flows", "energy-overview", "fan-control", "grid-status", "home-summary", "legacy-panel", "light-control", "media-player-control", "sensor-status", "solar-production", "switch-control", "vacuum-control", "weather-current", "weather-forecast"]);
