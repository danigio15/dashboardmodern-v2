...
function installStyles() {
  installStyle("dm-personalization-style", `
    ...
    .dm-unified-icon-row{grid-template-columns:72px minmax(0,1fr)!important}.dm-visual-pick-btn{display:none!important}.dm-visual-trigger,.dm-icon-preview-button{cursor:pointer!important;transition:transform .15s ease,box-shadow .15s ease!important}.dm-visual-trigger:hover,.dm-icon-preview-button:hover{transform:translateY(-1px)!important}.dm-unified-icon-preview.dm-visual-trigger,.dm-action-icon-preview.dm-visual-trigger{display:grid!important;place-items:center!important;width:72px!important;height:72px!important;border:1px solid var(--divider-color,#dbe4ee)!important;border-radius:18px!important;background:var(--secondary-background-color,#eef3f8)!important}/* Il riquadro dell'icona era l'unico controllo della configurazione vestito dal browser.
       Gli si diceva quanto grande e quanto arrotondato, mai di che colore: senza
       una regola sul bordo restava quello di serie — due pixel neri in rilievo su
       un grigio che non e' di nessun tema — mentre ogni cosa intorno ha il filo
       chiaro del tema e il fondo della plancia. Nel Report, dove i riquadri stanno
       in fila accanto ai pulsanti delle azioni, si vedeva bene: gli stessi
       quadratini, due stili diversi. Il vestito e' quello del riquadro grande
       accanto, in piccolo. */
    .dm-icon-picker.dm-icon-preview-button{display:grid!important;place-items:center!important;min-width:54px!important;width:54px!important;height:54px!important;padding:0!important;border:1px solid var(--divider-color,#dbe4ee)!important;border-radius:14px!important;background:var(--secondary-background-color,#eef3f8)!important;color:var(--text,#0f172a)!important;font-size:0!important}
    #editor-modal[data-dm-editor-theme="dark"] .dm-icon-picker.dm-icon-preview-button{border-color:var(--dm-editor-border,#31405f)!important;background:var(--dm-editor-control,#212d4c)!important;color:var(--dm-editor-text,#edf4ff)!important}.dm-temperature-card-icon{display:grid!important;place-items:center!important;width:52px!important;height:52px!important;border-radius:16px!important;background:color-mix(in srgb,var(--primary-color,#0ea5e9) 10%,transparent)!important;overflow:hidden!important}.dm-temperature-form{border:1px solid var(--divider-color,#dbe4ee)!important;border-radius:20px!important;padding:18px!important;background:var(--card-background-color,#fff)!important;display:grid!important;gap:14px!important}.dm-temperature-form>.ed-slot{margin:0!important}.dm-temperature-actions{display:flex!important;gap:10px!important;justify-content:flex-end!important}
