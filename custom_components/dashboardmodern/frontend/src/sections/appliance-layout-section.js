...
function installStyles() {
  installStyle(
    ...
    `
      #appl-grid-overview,#page-appliances-main .appl-grid,#page-appliances-main [data-appliance-grid]{display:grid!important;grid-template-columns:repeat(auto-fit,minmax(min(100%,360px),408px))!important;justify-content:start!important;align-items:stretch!important;gap:18px!important}
      #page-appliances-main .appl-wide-card,#appl-grid-overview .appl-wide-card{box-sizing:border-box!important;width:100%!important;max-width:none!important;min-height:178px!important;max-height:188px!important;border-radius:22px!important;overflow:hidden!important;grid-template-columns:128px minmax(0,1fr)!important;box-shadow:0 14px 30px color-mix(in srgb,#0f172a 14%,transparent)!important}
      ...
      #page-appliances-main .appl-wide-body,#appl-grid-overview .appl-wide-body{padding:14px 16px!important;align-content:start!important}
