...
function installStyles() {
  installStyle(
    ...
    `
      ...
      #page-appliances-main [data-dm-power-toggle="true"],#appl-grid-overview [data-dm-power-toggle="true"]{min-width:105px!important;background:linear-gradient(135deg,#10b981,#059669)!important;color:#fff!important;border:0!important;box-shadow:0 9px 20px rgba(5,150,105,.20)!important}
      #page-appliances-main [data-dm-power-toggle="true"][data-state="on"],#appl-grid-overview [data-dm-power-toggle="true"][data-state="on"]{background:linear-gradient(135deg,#ef4444,#dc2626)!important;box-shadow:0 9px 20px rgba(220,38,38,.17)!important}
