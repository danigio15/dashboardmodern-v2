...
function installStyles() {
  installStyle(
    ...
    `
      ...
      #page-appliances-main .appl-wide-card .appl-ic,#appl-grid-overview .appl-wide-card .appl-ic{display:grid!important;place-items:center!important;box-sizing:border-box!important;width:81px!important;height:81px!important;min-width:81px!important;min-height:81px!important;margin:0!important;padding:0!important;border:0!important;border-radius:18px!important;background:color-mix(in srgb,var(--primary-color,#0284c7) 7%,transparent)!important;box-shadow:none!important;overflow:hidden!important}
      ...
      @media(max-width:520px){
        ...
        #page-appliances-main .appl-wide-card .appl-ic,#appl-grid-overview .appl-wide-card .appl-ic{width:81px!important;height:81px!important;min-width:81px!important;min-height:81px!important;padding:0!important;border-radius:17px!important}
