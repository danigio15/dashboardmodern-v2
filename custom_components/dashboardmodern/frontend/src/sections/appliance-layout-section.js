...
function installStyles() {
  installStyle(
    ...
    `
      #appl-grid-overview,#page-appliances-main .appl-page-grid,#page-appliances-main .appl-grid,#page-appliances-main [data-appliance-grid]{display:grid!important;grid-template-columns:repeat(auto-fit,minmax(min(100%,360px),520px))!important;justify-content:start!important;align-items:stretch!important;gap:16px!important}
      #page-appliances-main .appl-wide-card,#appl-grid-overview .appl-wide-card{display:grid!important;box-sizing:border-box!important;width:100%!important;max-width:520px!important;min-width:0!important;min-height:154px!important;height:auto!important;padding:0!important;gap:0!important;border:1px solid color-mix(in srgb,var(--primary-color,#0284c7) 16%,var(--divider-color,#e2e8f0))!important;border-radius:22px!important;overflow:hidden!important;grid-template-columns:116px minmax(0,1fr)!important;background:var(--ha-card-background,var(--card-background-color,#fff))!important;color:var(--primary-text-color,#0f172a)!important;box-shadow:0 12px 28px color-mix(in srgb,#0f172a 12%,transparent)!important}
      ...
      #page-appliances-main .appl-visual,#appl-grid-overview .appl-visual{display:grid!important;place-items:center!important;box-sizing:border-box!important;min-width:116px!important;height:100%!important;min-height:154px!important;padding:16px!important;border-right:1px solid color-mix(in srgb,var(--primary-color,#0284c7) 11%,var(--divider-color,#e2e8f0))!important;background:color-mix(in srgb,var(--primary-color,#0284c7) 6%,var(--ha-card-background,#fff))!important}
      ...
      #page-appliances-main .appl-wide-card .appl-ic,#appl-grid-overview .appl-wide-card .appl-ic{display:grid!important;place-items:center!important;box-sizing:border-box!important;width:82px!important;height:82px!important;min-width:82px!important;min-height:82px!important;margin:0!important;padding:7px!important;border:0!important;border-radius:20px!important;background:color-mix(in srgb,var(--primary-color,#0284c7) 7%,transparent)!important;box-shadow:none!important;overflow:hidden!important}
      ...
      #page-appliances-main .appl-wide-body,#appl-grid-overview .appl-wide-body{display:grid!important;box-sizing:border-box!important;grid-template-rows:auto auto minmax(24px,1fr) auto!important;gap:5px!important;min-width:0!important;min-height:154px!important;height:auto!important;padding:13px 14px 12px!important;align-content:stretch!important;color:inherit!important;overflow:hidden!important}
      ...
      @media(max-width:520px){
        ...
        #page-appliances-main .appl-wide-card,#appl-grid-overview .appl-wide-card{grid-template-columns:102px minmax(0,1fr)!important;max-width:none!important;min-height:148px!important;border-radius:18px!important}
        #page-appliances-main .appl-visual,#appl-grid-overview .appl-visual{min-width:102px!important;min-height:148px!important;padding:12px!important}
        #page-appliances-main .appl-wide-card .appl-ic,#appl-grid-overview .appl-wide-card .appl-ic{width:76px!important;height:76px!important;min-width:76px!important;min-height:76px!important;border-radius:18px!important}
        #page-appliances-main .appl-wide-card .appl-ic svg,#appl-grid-overview .appl-wide-card .appl-ic svg,#page-appliances-main .appl-wide-card .appl-ic ha-icon,#appl-grid-overview .appl-wide-card .appl-ic ha-icon{width:62px!important;height:62px!important;--mdc-icon-size:62px}
        #page-appliances-main .appl-wide-body,#appl-grid-overview .appl-wide-body{min-height:148px!important;padding:11px 11px 10px!important}
        #page-appliances-main .appl-wide-name,#appl-grid-overview .appl-wide-name{font-size:16px!important}
        #page-appliances-main .appl-wide-actions,#appl-grid-overview .appl-wide-actions,#page-appliances-main .appl-actions,#appl-grid-overview .appl-actions{grid-template-columns:minmax(76px,.65fr) minmax(92px,1fr)!important;gap:6px!important}
        #page-appliances-main .appl-wide-actions button,#appl-grid-overview .appl-wide-actions button{min-height:36px!important;padding:6px 8px!important;font-size:10.5px!important}
      }
    `,
  );
}
