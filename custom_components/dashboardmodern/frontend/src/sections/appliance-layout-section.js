...
function installStyles() {
  installStyle(
    ...
    `
      ...
      #page-appliances-main .appl-visual,#appl-grid-overview .appl-visual{display:grid!important;place-items:center!important;min-width:112px!important;height:188px!important;background:color-mix(in srgb,var(--primary-color,#0284c7) 8%,var(--ha-card-background,#fff))!important}
      ...
      #page-appliances-main .appl-wide-card .dm-appliance-image-wrap,#appl-grid-overview .appl-wide-card .dm-appliance-image-wrap{box-sizing:border-box!important;width:100%!important;height:100%!important;min-width:84px!important;min-height:84px!important;max-width:none!important;max-height:none!important;overflow:hidden!important}
      ...
      /* The legacy card already renders an icon-only power button. The modern
         section adds the clearer Accendi/Spegni control, so keep exactly one. */
      #page-appliances-main .appl-actions:has([data-dm-power-toggle="true"])>.appl-action-btn:first-child:not(:last-child),#appl-grid-overview .appl-actions:has([data-dm-power-toggle="true"])>.appl-action-btn:first-child:not(:last-child){display:none!important}
