...
function installStyles() {
  installStyle("dm-editor-polish-style", `
    ...
    @media(max-width:720px){.dm-light-row{grid-template-columns:42px minmax(0,1fr) 44px 44px!important}.dm-light-row .dm-light-order{grid-template-columns:1fr!important}.dm-server-add{grid-template-columns:1fr!important}}
  `);
}
