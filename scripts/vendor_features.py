...
R28S_it_A = '<section class="page" id="page-appliances-main">\n  <div class="sub-tabs-container">\n    <div class="sub-tabs-energy">\n      <button class="sub-tab-btn appl-section-tab active" onclick="switchApplianceView(\'overview\', event)">📊 Panoramica</button>\n      <button class="sub-tab-btn appl-section-tab" onclick="switchApplianceView(\'kitchen\', event)">🍳 Cucina</button>\n      <button class="sub-tab-btn appl-section-tab" onclick="switchApplianceView(\'laundry\', event)">🧺 Lavanderia</button>\n      <button class="sub-tab-btn appl-section-tab" onclick="switchApplianceView(\'home\', event)">🏠 Casa</button>\n      <button class="sub-tab-btn appl-section-tab" onclick="switchApplianceView(\'other\', event)">🔌 Altro</button>\n      <button class="sub-tab-btn appl-section-tab" onclick="switchApplianceView(\'consumption\', event)">⚡ Consumi</button>\n      <button class="sub-tab-btn appl-section-tab" onclick="switchApplianceView(\'automations\', event)">🤖 Automazioni</button>\n    </div>\n  </div>\n  <div class="appl-main-hero">\n    <div><div class="appl-main-title">🧺 Elettrodomestici</div><div class="appl-main-sub" id="appl-main-sub">Configura cd_appliances in config.js o dall\'editor integrato.</div></div>\n    <button class="ed-btn-add appl-main-config" onclick="apriConfigEntita(); setTimeout(()=>editorSwitch(\'appliances\'),250)">⚙️ Configura</button>\n  </div>\n  <div class="glance-grid appl-kpi-grid" id="appl-kpi-grid"></div>\n  <div class="appl-main-view active" id="appl-view-overview"><h3 class="section-title">Panoramica</h3><div class="appl-page-grid" id="appl-grid-overview"></div></div>\n  <div class="appl-main-view" id="appl-view-kitchen"><h3 class="section-title">Cucina</h3><div class="appl-page-grid" id="appl-grid-kitchen"></div></div>\n  <div class="appl-main-view" id="appl-view-laundry"><h3 class="section-title">Lavanderia</h3><div class="appl-page-grid" id="appl-grid-laundry"></div></div>\n  <div class="appl-main-view" id="appl-view-home"><h3 class="section-title">Casa</h3><div class="appl-page-grid" id="appl-grid-home"></div></div>\n  <div class="appl-main-view" id="appl-view-other"><h3 class="section-title">Altro</h3><div class="appl-page-grid" id="appl-grid-other"></div></div>\n  <div class="appl-main-view" id="appl-view-consumption"><h3 class="section-title">Consumi</h3><div class="ed-chart-card"><div class="ed-chart-header"><div class="ed-chart-title">📈 Consumo istantaneo</div></div><div class="appl-consumption-list" id="appl-consumption-list"></div></div></div>\n  <div class="appl-main-view" id="appl-view-automations"><h3 class="section-title">Automazioni</h3><div class="appl-page-grid" id="appl-grid-automations"></div></div>\n</section>'
R28S_it_R = '<section class="page" id="page-appliances-main">\n  <h3 class="section-title" id="appliances-title" style="display:none;">Elettrodomestici</h3>\n  <div class="appliances-grid" id="appliances-grid"></div>\n</section>'
R28S_en_A = '<section class="page" id="page-appliances-main">\n  <div class="sub-tabs-container">\n    <div class="sub-tabs-energy">\n      <button class="sub-tab-btn appl-section-tab active" onclick="switchApplianceView(\'overview\', event)">📊 Overview</button>\n      <button class="sub-tab-btn appl-section-tab" onclick="switchApplianceView(\'kitchen\', event)">🍳 Kitchen</button>\n      <button class="sub-tab-btn appl-section-tab" onclick="switchApplianceView(\'laundry\', event)">🧺 Laundry</button>\n      <button class="sub-tab-btn appl-section-tab" onclick="switchApplianceView(\'home\', event)">🏠 Home</button>\n      <button class="sub-tab-btn appl-section-tab" onclick="switchApplianceView(\'other\', event)">🔌 Other</button>\n      <button class="sub-tab-btn appl-section-tab" onclick="switchApplianceView(\'consumption\', event)">⚡ Consumption</button>\n      <button class="sub-tab-btn appl-section-tab" onclick="switchApplianceView(\'automations\', event)">🤖 Automations</button>\n    </div>\n  </div>\n  <div class="appl-main-hero">\n    <div><div class="appl-main-title">🧺 Appliances</div><div class="appl-main-sub" id="appl-main-sub">Configure cd_appliances in config.js or in the integrated editor.</div></div>\n    <button class="ed-btn-add appl-main-config" onclick="apriConfigEntita(); setTimeout(()=>editorSwitch(\'appliances\'),250)">⚙️ Configure</button>\n  </div>\n  <div class="glance-grid appl-kpi-grid" id="appl-kpi-grid"></div>\n  <div class="appl-main-view active" id="appl-view-overview"><h3 class="section-title">Overview</h3><div class="appl-page-grid" id="appl-grid-overview"></div></div>\n  <div class="appl-main-view" id="appl-view-kitchen"><h3 class="section-title">Kitchen</h3><div class="appl-page-grid" id="appl-grid-kitchen"></div></div>\n  <div class="appl-main-view" id="appl-view-laundry"><h3 class="section-title">Laundry</h3><div class="appl-page-grid" id="appl-grid-laundry"></div></div>\n  <div class="appl-main-view" id="appl-view-home"><h3 class="section-title">Home</h3><div class="appl-page-grid" id="appl-grid-home"></div></div>\n  <div class="appl-main-view" id="appl-view-other"><h3 class="section-title">Other</h3><div class="appl-page-grid" id="appl-grid-other"></div></div>\n  <div class="appl-main-view" id="appl-view-consumption"><h3 class="section-title">Consumption</h3><div class="ed-chart-card"><div class="ed-chart-header"><div class="ed-chart-title">📈 Instant consumption</div></div><div class="appl-consumption-list" id="appl-consumption-list"></div></div></div>\n  <div class="appl-main-view" id="appl-view-automations"><h3 class="section-title">Automations</h3><div class="appl-page-grid" id="appl-grid-automations"></div></div>\n</section>'
R28S_en_R = '<section class="page" id="page-appliances-main">\n  <h3 class="section-title" id="appliances-title" style="display:none;">Appliances</h3>\n  <div class="appliances-grid" id="appliances-grid"></div>\n</section>'
